 ...
 * @author Sebas
 */
public class Viatico extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Viatico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
